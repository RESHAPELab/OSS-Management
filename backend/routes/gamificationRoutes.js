...
const { taskAnswer, taskCompletion, generateNextTask, taskNextHint, questCompletion, generateNextQuest, dynamicComment, updateReadme, unlockQuest, triggerCacheCommand, deployQuestToClass, unlockQuestForStudents, purpleDeployQuest, updateLiveTaskConfig, updateLiveQuestConfig } = require("../controllers/gamificationController")
...
router.route("/update-live-quest-config").post(updateLiveQuestConfig);
