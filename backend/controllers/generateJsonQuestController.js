  ...
  try {
    ...
    for (const taskData of tasks) {
      ...
      if (taskData.type === 'custom-api-call') {
        ...
        answer = '';
        answerType = 'text';
      } else if (taskData.type === 'validate-fork-url') {
        answer = '';
        answerType = 'custom';
      } else if (taskData.type === 'validate-file-exists') {
        answer = '';
        answerType = 'custom';
      } else if (taskData.type === 'validate-file-content') {
        answer = '';
        answerType = 'custom';
      } else if (taskData.type === 'validate-pr-url') {
        answer = '';
        answerType = 'custom';
      } else if (taskData.type === 'validate-push') {
        answer = '';
        answerType = 'custom';
      } else if (taskData.type === 'iterative-code-review') {
        answer = '';
        answerType = 'custom';
      } else if (taskData.type === 'bot-code-review') {
        answer = '';
        answerType = 'custom';
      } else {
        answer = taskData.correctAnswer || '';
