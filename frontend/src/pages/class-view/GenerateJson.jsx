...
const QuestBlock = ({
  ...
  if (hasTaskDuplicates) {
    questDuplicateMessages.push("Contains task(s) with duplicate titles");
  }
      ...
      <AccordionSummary>
        <Box sx={{ display: "flex", alignItems: "center", width: "100%" }}>
          <Box sx={{ flexGrow: 1 }}>
            ...
            {hasQuestDuplicate && questDuplicateMessages.length > 0 && (
              <Typography
                variant="caption"
                color="error"
                sx={{ display: "block" }}
