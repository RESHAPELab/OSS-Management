...
const ClassView = () => {
    ...
    const [isQuestConfigLoading, setIsQuestConfigLoading] = useState(true);
    ...
    useEffect(() => {
        const fetchGenerateJsonConfig = async () => {
            try {
                ...
                setIsQuestConfigLoading(false);
            }
        };
        if (classId) {
            fetchGenerateJsonConfig();
        } else {
            setIsQuestConfigLoading(false);
        }
    }, [classId]);
